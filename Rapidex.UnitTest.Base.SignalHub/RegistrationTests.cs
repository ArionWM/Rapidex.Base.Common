...
namespace Rapidex.UnitTest.Base.SignalHub;
public class RegistrationTests : IClassFixture<SingletonFixtureFactory<DefaultEmptyFixture>>
{
    ...
    public void Test01()
    {
        ...
        tree.Add("1", 1, "tenant1/workspace1/module111/signal111/target1", null);
        tree.Add("2", 2, "tenant1/workspace1/module111/signal111/+", null);

        tree.Add("3", 3, "tenant1/workspace1/module111/signal222", null); //Short registration, equal to '/#'
        tree.Add("4", 4, "tenant1/workspace1/module111/signal222/+", null);
        tree.Add("5", 5, "tenant1/workspace1/module111/signal222/#", null);

        tree.Add("6", 6, "tenant1/workspace1/module222/signal333/target2", null);
        tree.Add("7", 7, "tenant1/workspace1/module222/signal111/target2", null);
        tree.Add("8", 8, "tenant1/workspace1/module222/signal222/target1", null);
        ...
        Assert.Throws<ValidationException>(() =>
        {
            tree.Add("99", 99, "tenant1/workspace1/module111/+/target1", null);
        });
    ...
    public void Test02()
    {
        ...
        {
            Tenant = SignalTopic.ANY,
            Workspace = SignalTopic.ANY,
            Module = SignalTopic.ANY,
            Signal = SignalConstants.Signal_Editing,
        ...
        SignalTopic topic2 = new SignalTopic
        {
            ...
            Workspace = SignalTopic.ANY,
            Module = SignalTopic.ANY,
            Signal = SignalConstants.Signal_Importing,
            Entity = SignalTopic.ANY,
            EntityId = SignalTopic.ANY,
        };

        tree.Add("1", 1, topic1, null);
        tree.Add("2", 2, topic2, null);
